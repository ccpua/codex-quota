...
swiftc main.swift Preferences.swift QuotaView.swift HoverSurface.swift HoverGeometry.swift Updater.swift Preview.swift CodeActivity.swift CodeActivityTests.swift -o 'Codex Quota.app/Contents/MacOS/CodexQuota' -framework AppKit -lsqlite3 -module-cache-path build-cache -O
